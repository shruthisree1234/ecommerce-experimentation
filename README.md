...
Does the proposed discovery change increase orders per user?
...
Target high-value segments: Optimize onboarding for high-activity users

Optimize 2nd order milestone: Drive users to their 2nd order (100% retention threshold)

Department-specific discovery: Focus improvements on Produce & Dairy (40% of orders)
